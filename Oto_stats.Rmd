...
annu <- read.delim("Sample_2022/annuli_with_rad.txt", header = T, stringsAsFactors = F, sep = "\t", dec = ".")


#load SIMS data
sims <- read.delim("Otolith_data_2022_clean_core_with_distance_um.txt", sep = ";", 
