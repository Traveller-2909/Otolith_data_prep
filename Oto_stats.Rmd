...
#load SIMS data
sims <- read.delim("Sample_2022/Otolith_data_2022_clean_core_with_distance_um.txt", sep = ";", 
...
#load d18O data
pike_d18O <- read.delim("Sample_2022/pike_data_d18O_years.txt", sep = "\t", dec = ".",
                      header = T, stringsAsFactors = F)

#load LA-ICPMS data
pike_elements <- read.delim("Sample_2022/pike_data_LA-ICPMS_years_with_core.txt", sep = "\t",
