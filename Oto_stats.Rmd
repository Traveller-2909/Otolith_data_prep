...
Otopike <- Oto_all %>%
  ...
  #group_by(ID)%>%
  #mutate(measurement = order(desc(measurement_inv)))
...
write.table(Oto_distances, file = "Otolith_data_2021_clean_with_distance_um.txt", dec = ".", sep = ";", row.names = FALSE)
```
